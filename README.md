...
| List corresponding to data in specified row of Table 2(a) or 2(b) | `get_row_table2` | *J<sub>i</sub>*, *J<sub>f</sub>*, *L<sub>1</sub>*, *L<sub>2</sub>*, *<sup>*</sup>k*, *<sup>**</sup>coeff* |
