...
| Returned quantity | Method | Arguments |
| --- | --- | --- |
| $\texttt{DataFrame}$ representation of partial alignment anisotropy coefficients [[3]](#3) for user-defined arguments | `get_partial_table` | *J*, <sup>*</sup> *[&sigma;]*, <sup>*</sup> *[k]* |
